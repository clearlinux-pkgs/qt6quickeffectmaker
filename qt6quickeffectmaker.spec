...
Source0  : https://download.qt.io/official_releases/qt/6.5/6.5.3/submodules/qtquickeffectmaker-everywhere-src-6.5.3.tar.xz
...
%prep
%setup -q -n qtquickeffectmaker-everywhere-src-6.5.3
cd %{_builddir}/qtquickeffectmaker-everywhere-src-6.5.3
