...
Source0  : https://download.qt.io/official_releases/qt/6.8/6.8.0/submodules/qtquickeffectmaker-everywhere-src-6.8.0.zip
...
%prep
%setup -q -n qtquickeffectmaker-everywhere-src-6.8.0
cd %{_builddir}/qtquickeffectmaker-everywhere-src-6.8.0
pushd ..
cp -a qtquickeffectmaker-everywhere-src-6.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732647656
mkdir -p clr-build
pushd clr-build
