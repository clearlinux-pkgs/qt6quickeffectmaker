...
Version  : 6.6.0
Release  : 2
URL      : https://download.qt.io/official_releases/qt/6.6/6.6.0/submodules/qtquickeffectmaker-everywhere-src-6.6.0.tar.xz
Source0  : https://download.qt.io/official_releases/qt/6.6/6.6.0/submodules/qtquickeffectmaker-everywhere-src-6.6.0.tar.xz
...
%prep
%setup -q -n qtquickeffectmaker-everywhere-src-6.6.0
cd %{_builddir}/qtquickeffectmaker-everywhere-src-6.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697215542
mkdir -p clr-build
pushd clr-build
