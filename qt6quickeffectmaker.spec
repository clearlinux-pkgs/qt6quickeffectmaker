...
Source0  : https://download.qt.io/official_releases/qt/6.7/6.7.3/submodules/qtquickeffectmaker-everywhere-src-6.7.3.zip
...
%prep
%setup -q -n qtquickeffectmaker-everywhere-src-6.7.3
cd %{_builddir}/qtquickeffectmaker-everywhere-src-6.7.3
pushd ..
cp -a qtquickeffectmaker-everywhere-src-6.7.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727837721
mkdir -p clr-build
pushd clr-build
