...
Source0  : https://download.qt.io/official_releases/qt/6.8/6.8.2/submodules/qtquickeffectmaker-everywhere-src-6.8.2.zip
...
%prep
%setup -q -n qtquickeffectmaker-everywhere-src-6.8.2
cd %{_builddir}/qtquickeffectmaker-everywhere-src-6.8.2
pushd ..
cp -a qtquickeffectmaker-everywhere-src-6.8.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738710787
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/qt6/sbom/qqeffectmaker-6.8.2.spdx
