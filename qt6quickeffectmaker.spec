...
Version  : 6.7.1
Release  : 16
URL      : https://download.qt.io/official_releases/qt/6.7/6.7.1/submodules/qtquickeffectmaker-everywhere-src-6.7.1.zip
Source0  : https://download.qt.io/official_releases/qt/6.7/6.7.1/submodules/qtquickeffectmaker-everywhere-src-6.7.1.zip
...
%prep
%setup -q -n qtquickeffectmaker-everywhere-src-6.7.1
cd %{_builddir}/qtquickeffectmaker-everywhere-src-6.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716949254
mkdir -p clr-build
pushd clr-build
